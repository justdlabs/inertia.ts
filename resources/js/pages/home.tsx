                        ...
                        <div className="sm:p-20">
                            ...
                            <div className="mb-8 max-w-2xl">
                                <div className="mt-6 text-xl sm:text-2xl">
                                    Laravel application with Inertia and React
                                    Typescript!
                                </div>
                                <div className="mt-4 text-muted-fg sm:text-lg">
                                    This is a Laravel application with Inertia
                                    and React Typescript. It is a work in
                                    progress. If you have any questions or
